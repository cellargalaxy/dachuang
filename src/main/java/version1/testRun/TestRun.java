...
//import version1.feature.SnFeatureSelectionSubSpaceCreate;
...
//                SnFeatureSelectionSubSpaceCreate.POWER_ADJUST, 0,
...
//
//        int[] sn = {1, 2, 3, 4};
//        LinkedList<LinkedList<Integer>> subSpaces = SnFeatureSelectionSubSpaceCreate.createSubSpaces(features, impros, sn, 15, SnFeatureSelectionSubSpaceCreate.POWER_ADJUST, 0);
...
//        LinkedList<LinkedList<Integer>> subSpaces = SnFeatureSelectionSubSpaceCreate.createSubSpaces(features, impros, parameter.getSn(), parameter.getFnMin(), adjustMethodNum, d);
//        System.out.println("子空间:");
//        for (LinkedList<Integer> subSpace : subSpaces) {
//            System.out.println(subSpace);
//        }
