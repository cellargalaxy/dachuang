...
public class TestRun {
	...
	public static void main(String[] args) throws IOException, ClassNotFoundException {
		...
		for (double i = 0.1; i < 2.1; i+=0.1) {
			...
			dataSet.power(i);
			System.out.println(i+"\t"+Hereditary.superEvolutionAUC(dataSet,Hereditary.USE_ORDER,5));
		}


//		DataSet testDataSet=new DataSet(new File("/media/cellargalaxy/根/内/办公/xi/dachuang/dataSet/testAll.csv"),
//				",",0,2,3,1,5);
//		testDataSet.power(0.5);
//		testDataSet.mulChro(chro);
//		System.out.println("test:"+AUC.countAUCAll(testDataSet));
