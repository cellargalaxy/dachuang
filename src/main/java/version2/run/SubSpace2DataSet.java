...
//	public static final DataSet subSpace2DataSet(Map<DataSet,double[]> subSpaceMap, EvidenceSynthesis dsCount) throws IOException, ClassNotFoundException {
...
//				}
//				newId.getEvidences().add(dsCount.synthesisEvidenceOrder(id,chro));
//			}
//		}
//
