...
//
//
//	public final void evolution(HereditaryParameter hereditaryParameter, ParentChrosChoose parentChrosChoose, Evaluation aucCount) throws IOException, ClassNotFoundException {
//		initEvolution(dataSet,hereditaryParameter);
//		//最大AUC
//		maxAuc = aucCount.countIndexEvaluation(dataSet, maxChro);
...
//	}
//
//	public final void evolution(HereditaryParameter hereditaryParameter, ParentChrosChoose parentChrosChoose, Evaluation aucCount, Integer withoutEvidNum) throws IOException, ClassNotFoundException {
//		initEvolution(dataSet,hereditaryParameter);
//		//最大AUC
//		maxAuc = aucCount.countIndexEvaluation(dataSet, withoutEvidNum, maxChro);
//		double[][] chros = createInitChros();
//		do {
...
//	}
//
//	public final DataSet evolution(HereditaryParameter hereditaryParameter, ParentChrosChoose parentChrosChoose, Evaluation aucCount, List<Integer> withEvidNums) throws IOException, ClassNotFoundException {
...
//		//最大AUC
//		maxAuc = aucCount.countOrderEvaluation(cloneDataSet, withEvidNums, maxChro);
//		double[][] chros = createInitChros();
//		do {
...
//	}
//
//	private final double[][] createIndexNewChros(DataSet dataSet, double[][] oldChros, Evaluation aucCount, ParentChrosChoose parentChrosChoose) throws IOException, ClassNotFoundException {
//		yetIterCount++;
...
//	}
//
//	private final double[][] createIndexNewChros(DataSet dataSet, double[][] oldChros, Evaluation aucCount, ParentChrosChoose parentChrosChoose, Integer withoutEvidNum) throws IOException, ClassNotFoundException {
//		yetIterCount++;
//		if (yetIterCount > hereditaryParameter.getIterNum()) {
////			System.out.println("到达最大迭代次数，跳出迭代");
//			return null;
...
//	}
//
//	private final double[][] createOrderNewChros(DataSet cloneDataSet, double[][] oldChros, Evaluation aucCount, ParentChrosChoose parentChrosChoose) throws IOException, ClassNotFoundException {
//		yetIterCount++;
//		if (yetIterCount > hereditaryParameter.getIterNum()) {
////			System.out.println("到达最大迭代次数，跳出迭代");
//			return null;
...
//	}
//
//	private final Map<Double, double[]> indexDataSetMulChros(DataSet dataSet, Evaluation aucCount, double[][] chros) throws IOException, ClassNotFoundException {
...
//			map.put(aucCount.countIndexEvaluation(dataSet, chro), chro);
//		}
//		return map;
//	}
//
//	private final Map<Double, double[]> indexDataSetMulChros(DataSet dataSet, Evaluation aucCount, double[][] chros, Integer withoutEvidNum) throws IOException, ClassNotFoundException {
//		Map<Double, double[]> map = new TreeMap<Double, double[]>(new Comparator<Double>() {
//			public int compare(Double a, Double b) {
//				if (a > b) {
//					return -1;
...
//		});
//		for (double[] chro : chros) {
//			map.put(aucCount.countIndexEvaluation(dataSet, withoutEvidNum, chro), chro);
//		}
//		return map;
//	}
//
//	private final Map<Double, double[]> orderDataSetMulChros(DataSet cloneDataSet, Evaluation aucCount, double[][] chros) throws IOException, ClassNotFoundException {
//		Map<Double, double[]> map = new TreeMap<Double, double[]>(new Comparator<Double>() {
//			public int compare(Double a, Double b) {
//				if (a > b) {
//					return -1;
...
//		});
//		for (double[] chro : chros) {
//			map.put(aucCount.countOrderEvaluation(cloneDataSet, chro), chro);
//		}
//		return map;
//	}
//
