 ...
 */
public abstract class RunParameter {
	private double test;
	private double miss;
	...
	public abstract void doneReceiveCreateSubDataSet();
	
	public abstract void receiveCreateSubSpaces(double[] impros);
	
	public abstract void donereceiveCreateSubSpaces();
	...
	public void setFnMin(int fnMin) {
		this.fnMin = fnMin;
	}
}
